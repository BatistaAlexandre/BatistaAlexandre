...
const alexandre = {
  ...
  experience: "5+ years",
  location: "Brazil",
  focus: ["SaaS", "Web Applications", "Automation", "AI"],
  mission: "Turning ideas into useful and scalable products."
};
```
...
`SaaS Platforms` · `Web Applications` · `Dashboards`

`API Integrations` · `Automations` · `AI-Powered Tools`
